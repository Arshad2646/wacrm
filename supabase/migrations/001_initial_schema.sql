...
-- Enable UUID extension. Hosted Supabase keeps extensions in the
-- `extensions` schema, so UUID defaults below call the function with a
-- schema qualifier instead of relying on search_path.
