...
beforeEach(() => {
  h.state.account = {
    package_type: 'growth',
    feature_flags: { advanced_crm_tools_enabled: true },
  };
  h.state.owned = null;
...
describe('runAutomationsForTrigger — tenant isolation', () => {
  it('does not dispatch automations when Advanced CRM is disabled', async () => {
    h.state.account = {
      package_type: 'growth',
      feature_flags: { advanced_crm_tools_enabled: false },
    };
    h.state.owned = { id: 'c1' };
