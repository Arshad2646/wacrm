...
describe('capability predicates', () => {
  ...
  it('canManageAccountBot: admin+ only', () => {
    expect(canManageAccountBot('owner')).toBe(true);
    expect(canManageAccountBot('admin')).toBe(true);
    expect(canManageAccountBot('agent')).toBe(false);
    expect(canManageAccountBot('viewer')).toBe(false);
  });
