      ...
      <div className="flex items-center justify-between gap-2 border-b border-slate-800 bg-slate-900 px-3 py-3 sm:px-4">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          {conversation.lead_intent_detected && (
            <Badge
              variant="outline"
              className="hidden max-w-48 truncate border-emerald-500/40 bg-emerald-500/10 text-[10px] text-emerald-300 md:inline-flex"
              title={leadInterest || 'Buying intent detected'}
            >
